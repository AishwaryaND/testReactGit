...
import styles from './EDFStyle';
import { theme } from './EDFStyle';
      ...
      <View style={styles.parent}>
        ...
        >
          <Defs>
            <LinearGradient id="grad" x1="0" y1="0" x2="1" y2="0">
              ...
              <Stop
                offset="1"
                stopColor={theme.primaryColorThree}
                stopOpacity="1"
              />
            </LinearGradient>
          </Defs>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.textDesc}>
            ...
            with a variety of color variants of black and white(Open my style.js
            to dig deeper! )
          </Text>
