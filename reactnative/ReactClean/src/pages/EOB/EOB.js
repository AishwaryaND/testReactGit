...
import styles from './EOBStyle';
import {theme} from './EOBStyle';
    ...
    <>
      <View style={styles.parent}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.textIntro}>I am a Blue Wave Page</Text>
          <Text style={styles.textDesc}>
            I am a Ocean Blue Wave theme. I am primarily a light theme and come with a
            variety of color variants of blue and white.(Open my style.js to dig
            deeper! )
          </Text>
